 ...
 * @endcode
 */
$settings['hash_salt'] = 'McRtvq07RFyoBWmEyyH3A1XMFJ9bw1c-DEbKnMHektqiUhSpn1g6sxy3eCoPJBrTC5Zdl9T88g';
 ...
 */
if (getenv('APP_ENV')) {
  $local_settings = $app_root . '/' . $site_path . '/settings.' . getenv('APP_ENV') . '.php';
